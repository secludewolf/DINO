...
class WandbLogger():
    """Log training runs, datasets, models_yolo, and predictions to Weights & Biases.
    ...
    models_yolo and predictions can also be logged.
    ...
    def setup_training(self, opt):
        """
        Setup the necessary processes for training YOLO models_yolo:
